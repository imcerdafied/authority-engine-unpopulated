...
updated AS (
  ...
  SET
    ...
    impact_tier = 'High'::public.impact_tier,
    risk_level = 'healthy'::public.bet_risk_level,
...
SELECT
  ...
  'High'::public.impact_tier,
  'defined'::public.decision_status,
  'healthy'::public.bet_risk_level,
