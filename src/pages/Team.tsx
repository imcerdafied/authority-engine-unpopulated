      ...
      {isAdmin && (
        <section className="mb-8">
          ...
          <div className="border rounded-md p-4">
            <form onSubmit={handleInvite} className="flex flex-col md:flex-row md:flex-wrap md:items-end gap-3">
              <div className="w-full md:w-64">
                ...
                <input
                  ...
                  className="w-full border rounded-sm px-3 py-2 text-sm bg-background focus:outline-none focus:ring-1 focus:ring-foreground min-h-[44px]"
                />
              </div>
              ...
              <button
                ...
                className="text-[11px] font-semibold uppercase tracking-wider text-background bg-foreground px-4 py-2 rounded-sm hover:bg-foreground/90 transition-colors disabled:opacity-50 w-full md:w-auto min-h-[44px]"
              >
              ...
              <div key={inv.id} className="px-4 py-3 flex items-center justify-between">
                ...
                {isAdmin && (
                  <button
                    ...
                    className="text-[11px] font-semibold uppercase tracking-wider text-signal-red hover:underline min-h-[44px] min-w-[44px] flex items-center justify-center"
                  >
                    Revoke
                  </button>
                )}
